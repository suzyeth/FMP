...
public class UI : MonoBehaviour
{
    ...
    public float transitionTime = 5f; // ����ʱ��
    ...
    private void CheckImage()
    {
        ...
        //givingup-skills-page when chose which skill to give up,�Ϸ�����UIͼ����ʾ
        if (GUSSkill1 || GUSSkill2 || GUSSkill3 || GUSSkill4)
        {
           
            //ѡ�з����ļ��ܰ�ť֮�������ȷ�ϰ�ť��������ʧЧ״̬
    ...
    private void SubmittedSkillImage()
    {
        ...
        //�Ϸ�����UI�Ѿ���ʾ��,���ȷ��֮��,panel pageչʾҳ����ʾ,gusPage
        if (!gameData.GiveUpSkills1)
        {
    ...
    public float fillSpeed = 0.3f; // ����������ٶ�
    public float resetSpeed = 0.5f; // �����������ٶ�
    public float requiredFillAmount = 2.0f; // ��Ҫ������С��

    private float currentFillAmount1 = 0.0f; // ��ǰ������
    ...
    private void FillProgress()
    {
        ...
        //�ж����ĸ���ť�����£�stratbuttonLeft=1,stratbuttonRight=2,settingbuttonLeft=3,settingbuttonRight=4
    ...
    private void ResetProgress()
    {
        ...
        //�ж����ĸ���ť���ͷţ�stratbuttonLeft=1,stratbuttonRight=2,settingbuttonLeft=3,settingbuttonRight=4
        if (!StartingLeftButtonIsPressd)
        {
